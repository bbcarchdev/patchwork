...
static int patchwork_index_metadata_sparqlres_(QUILTREQ *request, struct query_struct *query, SPARQLRES *res);

/* Peform a query using the SPARQL back-end */
int
patchwork_query_sparql(QUILTREQ *request, struct query_struct *query)
{
	SPARQL *sparql;
	SPARQLRES *res;
	char limofs[128];
	...
	if((r = patchwork_index_metadata_sparqlres_(request, query, res)))
	{
...
int
patchwork_lookup_sparql(QUILTREQ *request, const char *target)
{
	SPARQL *sparql;
	SPARQLRES *res;
	SPARQLROW *row;
 ...
 */
static int
patchwork_index_metadata_sparqlres_(QUILTREQ *request, struct query_struct *query, SPARQLRES *res)
{
